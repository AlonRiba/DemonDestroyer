package com.BudniAsh.DemonDestroyer;
...
public class GameActivity extends AppCompatActivity {
  ...
  //  volatile boolean run = true;
    ...
    public void initialize(){
        ...
        monsters.add(new Monster(5,25,5, R.drawable.fiend));
        monsters.add(new Monster(6,35,5, R.drawable.spider));
        monsters.add(new Monster(7,45,4, R.drawable.imp));
        monsters.add(new Monster(8,75,4, R.drawable.brute));
        monsters.add(new Monster(9,150,2, R.drawable.demon));
        monsters.add(new Monster(10,150,2, R.drawable.demon));
        monsters.add(new Monster(11,150,8, R.drawable.fiend));
        monsters.add(new Monster(13,250,7, R.drawable.spider));
        monsters.add(new Monster(12,350,6, R.drawable.imp));
        monsters.add(new Monster(14,450,6, R.drawable.demon));
        monsters.add(new Monster(15,250,5, R.drawable.zombie));
        monsters.add(new Monster(16,350,5, R.drawable.spider));
        monsters.add(new Monster(17,450,4, R.drawable.imp));
        monsters.add(new Monster(18,550,4, R.drawable.brute));
        monsters.add(new Monster(19,1500,1, R.drawable.demon));
        monsters.add(new Monster(20,1500,2, R.drawable.demon));
